...
(function($PS) {
      ...
      return function (setS) {
          return function (update) {
              return function (interpreter) {
                  ...
                  var dispatch = function ($70) {
                      return runAction(update($70));
                  };
                  var dispatchEvent = function (ev) {
                      return function (handler) {
                          ...
                          return function __do() {
                              ...
                              throw new Error("Failed pattern match at Pha.App (line 46, column 13 - line 48, column 36): " + [ v.msg.constructor.name ]);
                          };
                      };
                  };
                  return {
  ...
  var app = function (v) {
      return function (v1) {
          var v2 = getTools(v1.getS)(v1.setS)(v.update)(v.interpreter);
  ...
  var functorRng = new Data_Functor.Functor(function (f) {
      return function (v) {
          return Rng(Data_Exists.runExists(function (v1) {
              return Data_Exists.mkExists(new GenWrapper(v1.value0, function ($25) {
                  return f(v1.value1($25));
              }));
          })(v));
      };
  });
